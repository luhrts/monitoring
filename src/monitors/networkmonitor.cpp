 ...
 */
void NetworkMonitor::getNetworkLoad(float& loadinPrx, float& loadinPtx, float& RXBpS, float& TXBpS)
{
...
//		}
  ...
  {
    ROS_WARN("No Max Network Throughput configured. Working with 100Mbit/s.");
  }
  ...
  benchmark.init();
  ROS_RT_MeasurementDuration* measurement_networkload_bytes = benchmark.createDurationMeasurement(
      "networkload_in_bytes");
